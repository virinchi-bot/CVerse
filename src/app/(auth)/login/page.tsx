        ...
        <div style={{ display: 'flex', minHeight: '100vh', background: '#0F1115', fontFamily: "'DM Sans', sans-serif" }}>
            ...
            <div id="auth-left" style={{
                ...
                <div style={{ marginBottom: '40px' }}>
                    <p style={{ fontSize: '11px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#6B7280', marginBottom: '12px' }}>Welcome back</p>
                    <h1 style={{
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                            <label style={{ fontSize: '11px', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#6B7280' }}>Password</label>
                            <Link href="/forgot-password" style={{ fontSize: '11px', color: '#7C8CFF', textDecoration: 'none', letterSpacing: '0.05em' }}>Forgot?</Link>
                        </div>
                        <input
                ...
                <p style={{ marginTop: '32px', fontSize: '12px', color: '#6B7280', textAlign: 'center' }}>
                    ...
                    <Link href="/register" style={{ color: '#7C8CFF', textDecoration: 'none' }}>Create one</Link>
                </p>
            </div>
